...
#===========================================================================
    ...
    return pos_ids
#===========================================================================
def load_ner_api(model_path: str = "", tokenizer_name: str = "", ):
#===========================================================================
    # Init
    ...
    while True:
        ...
        # input_sent = "필리핀 국민의 약 10%인 800만 명은 세계 곳곳에서 건설노동자 가정부 유모 등으로 힘들게 일한다."
        ...
        concat_tok_list = []
        curr_label = ""
        for idx, (ids, label, pos) in enumerate(zip(input_ids, conv_label_seq, conv_pos_ids)):
            ...
            if "B-" in label:
                ...
                if 0 < len(concat_tok_list) and "##" not in conv_tok and pos[0] not in giho_pos_ids:
        ...
        res_results_data.id = "1"
        res_json_str = make_response_json(res_data=res_results_data)
        # print(res_json_str)
        yield res_json_str
